...
namespace NetShop.Migrations
{
    ...
    [Migration("20230116111410_AddedCityInOrder")]
    partial class AddedCityInOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductProductAddress", b =>
                {
                    b.Property<int>("ProductAddressesId")
                        .HasColumnType("integer");

                    b.Property<int>("ProductsId")
                        .HasColumnType("integer");

                    b.HasKey("ProductAddressesId", "ProductsId");

                    b.HasIndex("ProductsId");

                    b.ToTable("ProductProductAddress");
                });
            ...
            modelBuilder.Entity("ProductProductAddress", b =>
                {
                    b.HasOne("NetShop.Models.ProductAddress", null)
                        .WithMany()
                        .HasForeignKey("ProductAddressesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
